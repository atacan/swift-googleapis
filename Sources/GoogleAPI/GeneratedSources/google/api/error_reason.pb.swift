...
extension Google_Api_ErrorReason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "ERROR_REASON_UNSPECIFIED"),
    1: .same(proto: "SERVICE_DISABLED"),
    2: .same(proto: "BILLING_DISABLED"),
    3: .same(proto: "API_KEY_INVALID"),
    4: .same(proto: "API_KEY_SERVICE_BLOCKED"),
    5: .same(proto: "RATE_LIMIT_EXCEEDED"),
    6: .same(proto: "RESOURCE_QUOTA_EXCEEDED"),
    7: .same(proto: "API_KEY_HTTP_REFERRER_BLOCKED"),
    8: .same(proto: "API_KEY_IP_ADDRESS_BLOCKED"),
    9: .same(proto: "API_KEY_ANDROID_APP_BLOCKED"),
    10: .same(proto: "LOCATION_TAX_POLICY_VIOLATED"),
    11: .same(proto: "USER_PROJECT_DENIED"),
    12: .same(proto: "CONSUMER_SUSPENDED"),
    13: .same(proto: "API_KEY_IOS_APP_BLOCKED"),
    14: .same(proto: "CONSUMER_INVALID"),
    15: .same(proto: "SECURITY_POLICY_VIOLATED"),
    16: .same(proto: "ACCESS_TOKEN_EXPIRED"),
    17: .same(proto: "ACCESS_TOKEN_SCOPE_INSUFFICIENT"),
    18: .same(proto: "ACCOUNT_STATE_INVALID"),
    19: .same(proto: "ACCESS_TOKEN_TYPE_UNSUPPORTED"),
    20: .same(proto: "CREDENTIALS_MISSING"),
    21: .same(proto: "RESOURCE_PROJECT_INVALID"),
    23: .same(proto: "SESSION_COOKIE_INVALID"),
    24: .same(proto: "USER_BLOCKED_BY_ADMIN"),
    25: .same(proto: "RESOURCE_USAGE_RESTRICTION_VIOLATED"),
    26: .same(proto: "SYSTEM_PARAMETER_UNSUPPORTED"),
    27: .same(proto: "ORG_RESTRICTION_VIOLATION"),
    28: .same(proto: "ORG_RESTRICTION_HEADER_INVALID"),
    29: .same(proto: "SERVICE_NOT_VISIBLE"),
    30: .same(proto: "GCP_SUSPENDED"),
    31: .same(proto: "LOCATION_POLICY_VIOLATED"),
    33: .same(proto: "MISSING_ORIGIN"),
    34: .same(proto: "OVERLOADED_CREDENTIALS"),
  ]
}
