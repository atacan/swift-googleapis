...
public struct Google_Ai_Generativelanguage_V1_CitationMetadata: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Citations to sources for a specific response.
  public var citationSources: [Google_Ai_Generativelanguage_V1_CitationSource] = []
...
public struct Google_Ai_Generativelanguage_V1_CitationSource: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Ai_Generativelanguage_V1_CitationMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Ai_Generativelanguage_V1_CitationMetadata, rhs: Google_Ai_Generativelanguage_V1_CitationMetadata) -> Bool {
...
extension Google_Ai_Generativelanguage_V1_CitationSource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Ai_Generativelanguage_V1_CitationSource, rhs: Google_Ai_Generativelanguage_V1_CitationSource) -> Bool {
