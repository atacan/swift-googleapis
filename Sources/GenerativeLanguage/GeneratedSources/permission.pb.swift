...
public struct Google_Ai_Generativelanguage_V1beta3_Permission: Sendable {
  ...
  public var granteeType: Google_Ai_Generativelanguage_V1beta3_Permission.GranteeType {
  ...
  public var role: Google_Ai_Generativelanguage_V1beta3_Permission.Role {
  ...
  public enum GranteeType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Google_Ai_Generativelanguage_V1beta3_Permission.GranteeType] = [
      .unspecified,
      .user,
      .group,
      .everyone,
  ...
  public enum Role: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Google_Ai_Generativelanguage_V1beta3_Permission.Role] = [
      .unspecified,
      .owner,
      .writer,
      .reader,
  ...
  fileprivate var _granteeType: Google_Ai_Generativelanguage_V1beta3_Permission.GranteeType? = nil
  fileprivate var _emailAddress: String? = nil
  fileprivate var _role: Google_Ai_Generativelanguage_V1beta3_Permission.Role? = nil
}
...
extension Google_Ai_Generativelanguage_V1beta3_Permission: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Ai_Generativelanguage_V1beta3_Permission, rhs: Google_Ai_Generativelanguage_V1beta3_Permission) -> Bool {
...
extension Google_Ai_Generativelanguage_V1beta3_Permission.GranteeType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Ai_Generativelanguage_V1beta3_Permission.Role: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
